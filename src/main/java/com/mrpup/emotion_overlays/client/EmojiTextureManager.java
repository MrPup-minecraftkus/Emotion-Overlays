...
public class EmojiTextureManager {
    ...
    private static void uploadToGpu(EmojiEntry entry, byte[] png) {
        Minecraft.getInstance().execute(() -> {
            try {
                ...
                DynamicTexture tex = new DynamicTexture(() -> "emoji_" + entry.cpHex(), img);
    ...
    public static void registerExternal(String cpHex, Identifier loc) {
