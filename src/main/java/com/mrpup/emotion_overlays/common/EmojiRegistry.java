...
public class EmojiRegistry {
    ...
    public static void load() {
        ...
        try (InputStream is = EmojiRegistry.class.getResourceAsStream("/assets/emotion_overlays/emoji.json")) {
            if (is == null) {
                LOGGER.error("[EmotionOverlays] cannot find emoji.json");
                return;
            }
            ...
            LOGGER.error("[EmotionOverlays] cannot load emoji.json", e);
        }
    }
